...
const TRAZOS = {
	...
	heart: "M12 20.3 4.6 13a4.9 4.9 0 0 1 0-7 4.9 4.9 0 0 1 7 0l.4.4.4-.4a4.9 4.9 0 0 1 7 7L12 20.3Zm-6-8.7 6 5.9 6-5.9a2.9 2.9 0 1 0-4.1-4.1L12 9.2l-1.9-1.7A2.9 2.9 0 1 0 6 11.6Z",
	"heart-filled": "M12 20.3 4.6 13a4.9 4.9 0 0 1 7-7l.4.4.4-.4a4.9 4.9 0 0 1 7 7L12 20.3Z",
	play: "M7 4v16l13-8L7 4Z",
	pause: "M6 4h4v16H6V4Zm8 0h4v16h-4V4Z",
	next: "M6 4l10 8-10 8V4Zm11 0h2v16h-2V4Z",
	previous: "M18 4v16L8 12l10-8ZM5 4h2v16H5V4Z",
	shuffle: "M17 3l4 4-4 4V8h-2.2l-2.3 3 2.3 3H17v-3l4 4-4 4v-3h-3.2l-2.9-3.8L7.8 18H3v-2h3.8l3-4-3-4H3V6h4.8l3 4 2.9-4H17V3Z",
	repeat: "M7 5h10v3l4-4-4-4v3H5v6h2V5Zm10 14H7v-3l-4 4 4 4v-3h12v-6h-2v4Z",
	"repeat-one": "M7 5h10v3l4-4-4-4v3H5v6h2V5Zm10 14H7v-3l-4 4 4 4v-3h12v-6h-2v4Zm-5-8h-1.5l-2 1v1.5l1.5-.7V17h2v-6Z",
	volume: "M4 9v6h4l5 5V4L8 9H4Zm12.5 3a4.5 4.5 0 0 0-2.5-4v8a4.5 4.5 0 0 0 2.5-4Z",
	"volume-mute": "M4 9v6h4l5 5V4L8 9H4Zm17.2-.6-1.4-1.4-2.3 2.3-2.3-2.3-1.4 1.4 2.3 2.3-2.3 2.3 1.4 1.4 2.3-2.3 2.3 2.3 1.4-1.4-2.3-2.3 2.3-2.3Z",
	queue: "M3 5h12v2H3V5Zm0 4h12v2H3V9Zm0 4h8v2H3v-2Zm14-8v8.2a3 3 0 1 0 2 2.8V7h3V5h-5Z",
	settings: "M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm0 6a2 2 0 1 1 0-4 2 2 0 0 1 0 4Zm9-2c0-.6 0-1.2-.1-1.7l2-1.6-2-3.4-2.4 1a8 8 0 0 0-3-1.7L15 2H9l-.5 2.6a8 8 0 0 0-3 1.7l-2.4-1-2 3.4 2 1.6a9.7 9.7 0 0 0 0 3.4l-2 1.6 2 3.4 2.4-1a8 8 0 0 0 3 1.7L9 22h6l.5-2.6a8 8 0 0 0 3-1.7l2.4 1 2-3.4-2-1.6c.1-.5.1-1.1.1-1.7Z",
	...
	"cloud-download": "M19.35 10.04A7.49 7.49 0 0 0 12 4a7.49 7.99 0 0 0-7.35 6.04A5.5 5.5 0 0 0 6.5 20H19a5 5 0 0 0 .35-9.96ZM17 13l-5 5-5-5h3V9h4v4h3Z",
	...
	clock: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16Zm-1 3v6l5 3 1-1.7-4-2.3V7h-2Z"
};
/**
* Crea un icono.
*
...
export function botonIcono(nombre, etiqueta, alPulsar, opciones = {}) {
...
export function cambiarIcono(boton, nombre, tamano = 20) {
