...
export function mountArtistView(contenedor, ruta) {
	...
	let detalle = null;
	const desmontadores = [];
	function filaDePista(pista, indice) {
	...
	void conEspera(secciones, library.artistDetail(artistId)).then((d) => {
		detalle = d;
		etiquetas();
	}).catch(() => {
