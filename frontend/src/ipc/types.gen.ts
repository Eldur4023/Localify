 ...
 */
export type LocalifyEvent = { "type": "trackChanged", trackId: string, source: string, } | { "type": "playStatusChanged", status: string, } | { "type": "volumeChanged", volume: number, } | { "type": "repeatModeChanged", mode: string, } | { "type": "shuffleChanged", enabled: boolean, } | { "type": "trackFinished", trackId: string, completed: boolean, msPlayed: number, } | { "type": "queueChanged", revision: bigint, } | { "type": "downloadStarted", trackId: string, } | { "type": "downloadPlayable", trackId: string, } | { "type": "downloadProgress", trackId: string, percent: number, } | { "type": "downloadCompleted", trackId: string, } | { "type": "downloadFailed", trackId: string, reasonKey: string, } | { "type": "availabilityChanged", trackId: string, availability: AvailabilityDto, } | { "type": "libraryChanged", scope: string, } | { "type": "playlistChanged", playlistId: string, kind: string, } | { "type": "playlistImportProgress", importId: string, done: number, total: number, } | { "type": "playlistImportFinished", importId: string, playlistId: string, } | { "type": "scanProgress", scanId: string, done: number, total: number, } | { "type": "searchRemoteReady", queryId: bigint, } | { "type": "settingsChanged", sections: Array<string>, } | { "type": "providerStatusChanged", provider: string, status: ProviderStatusDto, } | { "type": "libraryMoveProgress", moveId: string, done: number, total: number, } | { "type": "libraryPathChanged", path: string, } | { "type": "toast", level: string, messageKey: string, params: Array<[string, string]>, };
